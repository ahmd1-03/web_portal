...
<body class="bg-gray-50 text-gray-800">
  ...
  <nav
    ...
    <a href="{{ route('admin.dashboard') }}"
      ...
      aria-label="Kembali ke Dashboard Admin" title="Kembali ke Dashboard Admin">
      <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" stroke="currentColor" stroke-width="2"
      stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24" role="img" aria-hidden="true">
  ...
  <section
    ...
    <!-- Teks Sambutan -->
    <h1 class="text-4xl sm:text-5xl font-extrabold text-emerald-100 mb-4 relative z-10" data-aos="fade-down"
      style="text-shadow: 0 2px 6px rgba(0,0,0,0.3);">
      Selamat Datang
    </h1>
    <p class="text-emerald-200 text-lg max-w-xl mx-auto relative z-10" data-aos="fade-up"
    ...
    <div class="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] pointer-events-none" style="height: 120px;">
      <svg class="relative block w-full h-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 120"
  ...
  <main class="px-4 max-w-7xl mx-auto relative z-10">
    ...
    <form method="GET" action="{{ url('/') }}" class="mx-auto my-16 max-w-xs sm:max-w-md md:max-w-xl"
      data-aos="zoom-in">
      <div class="relative w-full">
        <!-- Input Search -->
        <input type="text" name="search" placeholder="Cari konten..." value="{{ old('search', $search ?? '') }}"

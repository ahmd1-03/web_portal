        ...
        <section class="mb-6 md:mb-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 lg:gap-6">
                ...
                <a href="{{ route('admin.detail') }}"
                    ...
                    <div>
                        <h3 class="text-base md:text-lg font-semibold text-purple-900">Log Aktivitas</h3>
                        <p class="text-xs md:text-sm text-purple-700">Pantau aktivitas sistem</p>
                    </div>
                </a>
